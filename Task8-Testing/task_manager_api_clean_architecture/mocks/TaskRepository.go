...
func (_m *TaskRepository) GetTaskById(c context.Context, id string) (*domain.Task, error) {
	ret := _m.Called(c, id)
...
func (_m *TaskRepository) UpdateTask(c context.Context, id string, task *domain.Task) error {
